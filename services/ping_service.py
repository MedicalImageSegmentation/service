...
from api.medicalImagesegmentation.ping.user_pb2 import pong
from api.medicalImagesegmentation.ping.user_pb2_http import PingServicer, register_ping_http_server
